  ...
  return (
    <div className="bg-custom-bg bg-repeat bg-[url('https://fffuel.co/images/sssvg/grid.svg')] px-10 sm:px-6 lg:px-8">
      ...
      <div className=" text-white px-40">
          ...
          <div className="text-white mb-6 text-xl" >Access all of our powerful features directly through WhatsApp in your phone.</div>
          <div className="text-white mb-20 text-xl">Experience learning through natural, conversational interactions. With BotsApp, you can ask questions, seek clarification, and engage in dynamic discussions—all within the familiar WhatsApp chat interface.</div>
      ...
      <div className="px-40 pb-40 pt-20 ">
        ...
        <div className="text-white my-10 text-xl">Whether you're on the bus, waiting in line, or simply relaxing at home, your learning journey is always with you. Break free from traditional constraints and embrace the flexibility of learning on your terms.</div>
        ...
        <div className="w-1/3 bg-[#1E1E20] border border-3 border-[#1E1E20] rounded-lg shadow-md shadow-gray-500/50 translate-x-0 hover:translate-y-2 transition duration-300 ease-in-out">
         ...
         <div className="w-1/3  bg-[#1E1E20] border border-3 border-[#1E1E20] rounded-lg shadow-md shadow-gray-500/50 translate-x-0 hover:translate-y-2 transition duration-300 ease-in-out">
          <div className="w-full p-6 ">
             <div className="text-white font-bold text-lg text-[#6F53FF]">Round-the-Clock Availability</div>
