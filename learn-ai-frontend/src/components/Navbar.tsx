        ...
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              >
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-md text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      {/* <span className="absolute -inset-1.5" />
          ...
          {dialogueOpen && (
            <LoginDialogue
              ...
              closeDialogue={closeLoginDialogue}
            />
          )}
        </>
      )}
